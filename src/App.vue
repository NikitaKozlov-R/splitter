        ...
        <div class="tip-selector">
          ...
          <div class="tip-selector-grid">
            <div class="tip-selector-grid-card">
              <input 
                type="radio" name="tip" id="5" value="5"
                v-model="tipSelect"
                @click="isDesabled">
              <label for="5">5%</label>
            </div>
            <div class="tip-selector-grid-card">
              <input 
                type="radio" name="tip" id="10" value="10"
                v-model="tipSelect"
                @click="isDesabled">
            ...
            <div class="tip-selector-grid-card">
              <input 
                type="radio" name="tip" id="15" value="15"
                v-model="tipSelect"
                @click="isDesabled">
            ...
            <div class="tip-selector-grid-card">
              <input 
                type="radio" name="tip" id="25" value="25"
                v-model="tipSelect"
                @click="isDesabled">
            ...
            <div class="tip-selector-grid-card">
              <input 
                type="radio" name="tip" id="50" value="50"
                v-model="tipSelect"
                @click="isDesabled">
...
export default {
  ...
  computed: {
    resultTotalFunc() {
      if(this.billSelect == null || this.billSelect == 0 || this.peopleSelect == null || this.peopleSelect == 0) { return "0.00" }
      else {
